...
![](assets/img/lecture/bid_geonode.png){fig-align="center"} 
...
![](assets/img/lecture/satellite_b.png){.absolute top=10 right=5 width=120}
...
[**Field data will always be needed! :)**]{style="color: #e81f76;"}
...
## Opportunities: some low hanging fruits
...
- A number of recent and upcoming missions for hyper-spectral data: PRISMA, EnMap, Sentinel CHIME, TIRS 
- Cheaper UAVs with different types of cameras, e.g. thermal multi or hyper-pectral to detect and count animals

![](assets/img/lecture/map_monkeys_with_drones_tir.png){fig-align="center"}
