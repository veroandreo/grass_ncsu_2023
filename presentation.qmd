...
::: {.notes}
While RS has applications in all fields, I'll focus on those related to disease 
ecology as it is where I have worked the most
:::
...
::: {.notes}
However, we should take into account some basic features of remote sensing before
...
![Pine beetle infection](https://woodwright.net/wp-content/uploads/2019/06/Mountain-Pine-Beetle-Feature-image-Woodwright.jpg)
...
![](assets/img/lecture/sandfly.png){.absolute top=30 right=-30 width=200}
...
::: footer
Grippa et al., 2017; Georganos et al., 2018
:::
...
::: {layout="[1, 20]"}
![](assets/img/lecture/tomi.png){width="41"}
...
- Online integrated surveillance system for vector-borne diseases based on spatial information 
- GRASS, R, GeoNode, etc

![](assets/img/lecture/bid_etapas_flujo_de_trabajo.drawio.png)

![](assets/img/lecture/bid_logos.png) 

## Other applications in the pipeline {.smaller}

::: {layout="[1, 20]"}
![](assets/img/lecture/abraham.png){width="41"}

Incidence of asthma as a function of remotely sensed air quality and LULCC (citizen science and web data mining). PhD Thesis project Abraham Coiman.
:::

::: {layout="[1, 20]"}
![](assets/img/lecture/carlita.png){width="41"}
Distribution of congenit diseases and access to health in the triple border Argentina-Bolivia-Paraguay. PhD thesis project Carla Rodriguez Gonzalez.
:::
...
- SAR data, e.g., SAOCOM to estimate soil moisture
- LiDAR data, e.g., GEDI onboard of ISS
- GEE, openEO, actinia
