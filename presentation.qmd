...
[](https://geoportal.conae.gov.ar/mapstore/#/viewer/openlayers/geoportal)

![](assets/img/lecture/riesgo_dengue_por_localidad.png)

::: footer
[Porcasi et al., 2012](https://geospatialhealth.net/index.php/gh/article/view/120)
:::

## Remote sensing variables as predictors

![](assets/img/lecture/sdm_workflow.png)

## SDM & GIS based approach for HPS risk mapping
...
![](assets/img/lecture/fig_avg_pred.png)
:::
...
## Mosquitoes: towards an operational workflow
...
## Mosquitoes: temporal patterns and micro-habitat
...
- Object-based classification of very high spatial resolution (0.5-2 m) imagery.
- Estimation of landscape structure metrics for different polygons
- Clustering analysis to find similar polygons
- Stratified distribution of ovitraps as a function of environmental variability


## Mosquitoes: Predictive system based on population dynamics and weather forecasting models

![](assets/img/lecture/AT_class_diagram.png)
![](assets/img/lecture/Fig _agui.png)
...
## Algorithm and system for (semi-)automatic counting of mosquito eggs in ovitraps

[https://ovitrap-monitor.netlify.app/](https://ovitrap-monitor.netlify.app/)

## Other projects underway or in the pipeline
...
Environmental variables associated with non-communicable diseases (Postdoctoral fellow Julius Koritschoner)
...
## Thanks! {background-image="assets/img/lecture/CONAE_aereo.png"}
